...
if (process.argv.length <= 2) {
	console.log("Kullanim: node rodril7.js <url> <zaman>");
	console.log("Kullanim: node rodril7.js <http://rodri.com> <80>");
	process.exit(-1);
}
var hedefim = process.argv[2];
var donusturucum = url.parse(hedefim);
var sunucum = url.parse(hedefim).sunucum;
var zamanim = process.argv[3];
